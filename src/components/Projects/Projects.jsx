...
const projects = [
  ...
  },
  {
    ...
    description:
      "Are you a Rap God? A front-end trivia game leveraging Javascript/jQuery and Bootstrap and unique responsive design.",
      ...
      <div className={classes.section} style={{ display: this.props.show }}>
        <div className="container">
          <div className="title" style={{ marginTop: "0" }}>
            <h1 className="screen" id="portfolio">
              Portfolio
            </h1>
          </div>
              ...
              return (
                <Fade bottom>
                  <Project
                    ...
                    click={() => this.handleClickOpen(elem.title, elem.readme)}
                  />
                </Fade>
              );
            })}
        ...
        >
          ...
          <Fab
            color="primary"
            aria-label="play"
            className={this.state.showScroll > 500 ? "hidden" : "fab-play"}
            style = {{opacity: "0.9"}}
            onClick={this.handleClose}
          >
            <CloseIcon />
