  ...
  render() {
    ...
    return (
      <div className={classes.section} style={{ display: this.props.show }}>
          ...
          <div className="about-me">
            ...
            <div className="about-me-body">
              ...
              <p className="about-me-text">
                ...
                . I have worked as a Prototype Engineer and a Clinical Research
                Assistant and designed a surgical robot for minimally-invasive
                surgery. I have tutored high-school students extensively to
                improve their SAT, ACT, and SAT II scores to succesfully earn
                admission to the top colleges of their choice.
              </p>
              <p className="about-me-text">
        ...
        <Fab color="primary" aria-label="play" className={ this.state.firstAudioClick ? "hidden" : "fab-play"}  onClick={this.playJazz}>
          <PlayIcon
            style={{
              display: this.state.button === "play" ? "block" : "none"
            }}
